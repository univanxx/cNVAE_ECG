...
from model_conditional_1d_ultra import AutoEncoder
import utils
...
def main(args):
    ...
    train_dataset = CVConditional(args.data_dir, "ptb-xl", option="train")
    valid_dataset = CVConditional(args.data_dir, "ptb-xl", option="val") 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--add_label', action='store_true')
    ...
    args.save = args.root + args.name + '_' + str(args.num_input_channels) + appendix
    if args.small == True:
        args.data_dir = os.path.join(args.data_dir, "smaller")
    else:
        args.data_dir = os.path.join(args.data_dir, "bigger")
